...
public class GhostActivity extends AppCompatActivity {
    ...
    private void computerTurn() {
        ...
        if (dictionary.isWord(currentWord) && currentWord.length() >= 4) {
            ...
            Toast.makeText(this, "Word is VALID with length >4 YOU LOST", Toast.LENGTH_LONG).show();
            afterCheck=true;
            userTurn=false;
        }
        // 2.Use the dictionary's getAnyWordStartingWith method to get a possible longer word with currentWord as a prefix
        else {
            String randomWord = dictionary.getAnyWordStartingWith(currentWord);
             ...
             **/
            if (randomWord == null) {
                status.setText("you can't bluff this computer , you lost");
                Toast.makeText(this, "current word is INVALID YOU LOST", Toast.LENGTH_LONG).show();
                afterCheck=true;
                userTurn=false;
            }
        ...
        if(userTurn==true) {
            if (afterCheck == false) {
                ...
                if (Character.isLetter(keyPressed)) {
                    ...
                    Toast.makeText(this, "Invalid INPUT please check", Toast.LENGTH_SHORT).show();
        ...
        if(userTurn==true) {
            ...
            //If it has at least 4 characters and is a valid word, declare victory for the user
                ...
                //If a word cannot be formed with the fragment, declare victory for the user
                    ...
                    status.setText("You Won, computer lost this game");
                    Toast.makeText(this, "You Beat CPU", Toast.LENGTH_LONG).show();
                    afterCheck = true;
                }
            }
